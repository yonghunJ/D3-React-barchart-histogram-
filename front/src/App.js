...
function App() {
  ...
  const [data2, setData2] = useState('men')
  ...
  return (
    <>
      ...
      <Container style={{ backgroundColor: "lightblue"}}>
        <Row>
          <Col xs={12}>
            <ChartWrapper gender ={data} chart = {chart}/>
          </Col>
        </Row>
        <Row >
          <Col xs={12}><GenderDropdown DataSelected = {setData } chartelected = {setChart }/></Col>
        </Row>
      ...
      <Container  style={{ backgroundColor: "lightblue"}}>
        ...
        <Row>
          <Col xs={12}>
            <ChartWrapper2 gender ={data2} chart = {chart2} value= {value}/>
          </Col>
        </Row>
        <Row >
          <Col xs={6}><GenderDropdown2 DataSelected = {setData2 } chartelected = {setChart2 } /></Col>
          <Col xs={6}>
